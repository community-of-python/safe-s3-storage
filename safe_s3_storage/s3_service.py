...
class S3Service:
    ...
    async def _retrieve_file_object(self, *, s3_path: str) -> GetObjectOutputTypeDef:
        ...
        # TODO: remove retries, they should be configured in s3 client, add info in readme  # noqa: FIX002, TD002, TD003
    ...
    async def create_file_url(
        ...
        presigned_url: typing.Final = await stamina.retry(
            on=botocore.exceptions.BotoCoreError, attempts=self.max_retries
